...
RUN npm install -g colors@1.4.0 highcharts-export-server@2.0.28 --registry https://repository.gbif.org/content/repositories/npmjs/ --unsafe-perm

# Install app and dependencies
COPY . /usr/src/app
RUN npm install --registry https://repository.gbif.org/content/repositories/npmjs/ --save
